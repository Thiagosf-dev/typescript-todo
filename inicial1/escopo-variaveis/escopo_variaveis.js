var car = "Ferrari"; // imprime: car = Ferrari
/**
 ...
 */
function f(value) {
    var a = 100; // declaração de variável de escopo (let)
    if (value) {
        var b = a + 1; // neste escopo (do if) se encherga a variável a
        // imprime: b
        // imprime: a
    }
    // imprime: a
...
function g(condicao, x) {
    if (condicao) {
        var x_1 = 100;
        return x_1; // imprime: x = 100 (fixo)
    }
